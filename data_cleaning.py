...
class DataCleaning(DataProcessor):
    ...
    def clean_store_df(self, store_df):
        ...
        cleaned_store_df = DataProcessor.drop_null_values(store_df)
    ...
    def clean_users_df(self, users_df):
        ...
        cleaned_users_df = DataProcessor.drop_null_values(users_df)
    ...
    def clean_orders_df(self, orders_df):
        ...
        cleaned_orders_df = DataProcessor.drop_null_values(orders_df)
